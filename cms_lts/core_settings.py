# coding=utf-8
"""
Django settings for cms_lts project.
...
TEMPLATES = [
    {
		...
		'django.template.context_processors.i18n',
  		...
  		'cms_lts.context_processors.template_content', #for own templating system
            ],
        },
    },
]

WSGI_APPLICATION = 'cms_lts.wsgi.application'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, "cms_lts/static"),
]
